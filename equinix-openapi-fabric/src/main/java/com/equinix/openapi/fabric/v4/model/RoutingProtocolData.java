...
public class RoutingProtocolData extends AbstractOpenApiSchema {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<RoutingProtocolData>() {
                ...
                public void write(JsonWriter out, RoutingProtocolData value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match anyOf schemas: RoutingProtocolBGPData, RoutingProtocolDirectData");
                }
                ...
                public RoutingProtocolData read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        ret.setActualInstance(adapterRoutingProtocolBGPData.fromJsonTree(jsonObject));
                        return ret;
                    } catch (Exception e) {
                    ...
                    try {
                        ...
                        RoutingProtocolData ret = new RoutingProtocolData();
                        ret.setActualInstance(adapterRoutingProtocolDirectData.fromJsonTree(jsonObject));
                        return ret;
                    } catch (Exception e) {
                        // deserialization failed, continue
                    ...
                    throw new IOException(String.format("Failed deserialization for RoutingProtocolData: no class matched. JSON: %s", jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount == 0) {
      throw new IOException(String.format("The JSON string is invalid for RoutingProtocolData with anyOf schemas: RoutingProtocolBGPData, RoutingProtocolDirectData. JSON: %s", jsonObj.toString()));
    }
  }
