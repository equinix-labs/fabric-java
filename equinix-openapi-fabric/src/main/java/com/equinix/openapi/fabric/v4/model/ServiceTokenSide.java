...
public class ServiceTokenSide {
  ...
  private List<AccessPointSelector> accessPointSelectors = null;
  ...
  **/
   ...
   * @return the ServiceTokenSide instance itself
   */
  public ServiceTokenSide putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessPointSelectors, serviceTokenSide.accessPointSelectors)&&
        Objects.equals(this.additionalProperties, serviceTokenSide.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accessPointSelectors, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("accessPointSelectors");
      ...
      if (jsonObj.get("accessPointSelectors") != null && !jsonObj.get("accessPointSelectors").isJsonNull()) {
        ...
        if (jsonArrayaccessPointSelectors != null) {
          ...
          if (!jsonObj.get("accessPointSelectors").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `accessPointSelectors` to be an array in the JSON string but got `%s`", jsonObj.get("accessPointSelectors").toString()));
          }
