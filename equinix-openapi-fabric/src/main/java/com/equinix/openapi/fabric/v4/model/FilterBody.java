...
public class FilterBody {
  ...
  **/
   ...
   * @return the FilterBody instance itself
   */
  public FilterBody putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.filter, filterBody.filter)&&
        Objects.equals(this.additionalProperties, filterBody.additionalProperties);
  }
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FilterBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FilterBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FilterBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FilterBody.class));

       return (TypeAdapter<T>) new TypeAdapter<FilterBody>() {
           @Override
           public void write(JsonWriter out, FilterBody value) throws IOException {
