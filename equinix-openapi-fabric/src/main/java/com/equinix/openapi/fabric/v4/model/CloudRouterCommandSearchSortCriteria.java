...
import com.equinix.openapi.fabric.v4.model.CloudRouterCommandSearchSortBy;
import com.equinix.openapi.fabric.v4.model.CloudRouterCommandSearchSortDirection;
...
public class CloudRouterCommandSearchSortCriteria {
  ...
  **/
   ...
   * @return the CloudRouterCommandSearchSortCriteria instance itself
   */
  public CloudRouterCommandSearchSortCriteria putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CloudRouterCommandSearchSortCriteria cloudRouterCommandSearchSortCriteria = (CloudRouterCommandSearchSortCriteria) o;
    return Objects.equals(this.direction, cloudRouterCommandSearchSortCriteria.direction) &&
        Objects.equals(this.property, cloudRouterCommandSearchSortCriteria.property)&&
        Objects.equals(this.additionalProperties, cloudRouterCommandSearchSortCriteria.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CloudRouterCommandSearchSortCriteria {\n");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CloudRouterCommandSearchSortCriteria.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CloudRouterCommandSearchSortCriteria' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CloudRouterCommandSearchSortCriteria> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CloudRouterCommandSearchSortCriteria.class));

       return (TypeAdapter<T>) new TypeAdapter<CloudRouterCommandSearchSortCriteria>() {
           @Override
           public void write(JsonWriter out, CloudRouterCommandSearchSortCriteria value) throws IOException {
