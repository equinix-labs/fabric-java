...
public class GCPCloudRouterResponse {
  ...
  **/
   ...
   * @return the GCPCloudRouterResponse instance itself
   */
  public GCPCloudRouterResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GCPCloudRouterResponse gcPCloudRouterResponse = (GCPCloudRouterResponse) o;
    return Objects.equals(this.id, gcPCloudRouterResponse.id) &&
        Objects.equals(this.state, gcPCloudRouterResponse.state) &&
        Objects.equals(this.type, gcPCloudRouterResponse.type) &&
        Objects.equals(this.vpcId, gcPCloudRouterResponse.vpcId) &&
        Objects.equals(this.subnetId, gcPCloudRouterResponse.subnetId) &&
        Objects.equals(this.deploymentProperties, gcPCloudRouterResponse.deploymentProperties)&&
        Objects.equals(this.additionalProperties, gcPCloudRouterResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, state, type, vpcId, subnetId, deploymentProperties, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GCPCloudRouterResponse {\n");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GCPCloudRouterResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GCPCloudRouterResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GCPCloudRouterResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GCPCloudRouterResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GCPCloudRouterResponse>() {
           @Override
           public void write(JsonWriter out, GCPCloudRouterResponse value) throws IOException {
