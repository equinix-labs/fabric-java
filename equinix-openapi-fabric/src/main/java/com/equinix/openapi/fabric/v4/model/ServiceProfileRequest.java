...
public class ServiceProfileRequest {
  ...
  **/
   ...
   * @return the ServiceProfileRequest instance itself
   */
  public ServiceProfileRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.visibility, serviceProfileRequest.visibility) &&
        ...
        Objects.equals(this.additionalProperties, serviceProfileRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(visibility, customFields, description, marketingInfo, type, ports, uuid, accessPointTypeConfigs, selfProfile, tags, allowedEmails, virtualDevices, name, href, projectId, notifications, metros, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServiceProfileRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServiceProfileRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServiceProfileRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServiceProfileRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServiceProfileRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServiceProfileRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ServiceProfileRequest>() {
           @Override
           public void write(JsonWriter out, ServiceProfileRequest value) throws IOException {
           ...
           @Override
           public ServiceProfileRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServiceProfileRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServiceProfileRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServiceProfileRequest
  * @throws IOException if the JSON string is invalid with respect to ServiceProfileRequest
  */
  public static ServiceProfileRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServiceProfileRequest.class);
  }

 /**
  * Convert an instance of ServiceProfileRequest to an JSON string
  *
  * @return JSON string
  */
