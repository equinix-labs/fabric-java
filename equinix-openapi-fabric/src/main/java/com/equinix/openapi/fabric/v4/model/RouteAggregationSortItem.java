...
public class RouteAggregationSortItem {
  ...
  **/
   ...
   * @return the RouteAggregationSortItem instance itself
   */
  public RouteAggregationSortItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RouteAggregationSortItem routeAggregationSortItem = (RouteAggregationSortItem) o;
    return Objects.equals(this.property, routeAggregationSortItem.property) &&
        Objects.equals(this.direction, routeAggregationSortItem.direction)&&
        Objects.equals(this.additionalProperties, routeAggregationSortItem.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class RouteAggregationSortItem {\n");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RouteAggregationSortItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RouteAggregationSortItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RouteAggregationSortItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RouteAggregationSortItem.class));

       return (TypeAdapter<T>) new TypeAdapter<RouteAggregationSortItem>() {
           @Override
           public void write(JsonWriter out, RouteAggregationSortItem value) throws IOException {
