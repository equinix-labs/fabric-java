...
import com.equinix.openapi.fabric.v4.model.SortCriteriaResponse;
...
public class ConnectionSearchResponse {
  ...
  private List<SortCriteriaResponse> sort = null;
  ...
  **/
   ...
   * @return the ConnectionSearchResponse instance itself
   */
  public ConnectionSearchResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, connectionSearchResponse.data) &&
        Objects.equals(this.pagination, connectionSearchResponse.pagination) &&
        Objects.equals(this.sort, connectionSearchResponse.sort)&&
        Objects.equals(this.additionalProperties, connectionSearchResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(data, pagination, sort, additionalProperties);
  }
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConnectionSearchResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConnectionSearchResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConnectionSearchResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConnectionSearchResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ConnectionSearchResponse>() {
           @Override
           public void write(JsonWriter out, ConnectionSearchResponse value) throws IOException {
