...
public class StatisticsApi {
     ...
     */
    public okhttp3.Call getConnectionStatsByPortUuidCall(UUID connectionId, OffsetDateTime startDateTime, OffsetDateTime endDateTime, ViewPoint viewPoint, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getConnectionStatsByPortUuidValidateBeforeCall(UUID connectionId, OffsetDateTime startDateTime, OffsetDateTime endDateTime, ViewPoint viewPoint, final ApiCallback _callback) throws ApiException {
     ...
     */
    public Statistics getConnectionStatsByPortUuid(UUID connectionId, OffsetDateTime startDateTime, OffsetDateTime endDateTime, ViewPoint viewPoint) throws ApiException {
     ...
     */
    public ApiResponse<Statistics> getConnectionStatsByPortUuidWithHttpInfo(UUID connectionId, OffsetDateTime startDateTime, OffsetDateTime endDateTime, ViewPoint viewPoint) throws ApiException {
     ...
     */
    public okhttp3.Call getConnectionStatsByPortUuidAsync(UUID connectionId, OffsetDateTime startDateTime, OffsetDateTime endDateTime, ViewPoint viewPoint, final ApiCallback<Statistics> _callback) throws ApiException {
     ...
     * @param projectId projectId (optional, default to 123456789)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
