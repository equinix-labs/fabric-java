...
public class ServiceProfileAccessPointType {
  ...
  **/
   ...
   * @return the ServiceProfileAccessPointType instance itself
   */
  public ServiceProfileAccessPointType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, serviceProfileAccessPointType.type) &&
        Objects.equals(this.uuid, serviceProfileAccessPointType.uuid)&&
        Objects.equals(this.additionalProperties, serviceProfileAccessPointType.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, uuid, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServiceProfileAccessPointType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServiceProfileAccessPointType is not found in the empty JSON string", ServiceProfileAccessPointType.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServiceProfileAccessPointType.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<ServiceProfileAccessPointType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServiceProfileAccessPointType.class));
       ...
       return (TypeAdapter<T>) new TypeAdapter<ServiceProfileAccessPointType>() {
           ...
           public ServiceProfileAccessPointType read(JsonReader in) throws IOException {
             ...
             ServiceProfileAccessPointType instance = thisAdapter.fromJsonTree(jsonObj);
