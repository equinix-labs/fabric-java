...
public class TopologyProperties {
  ...
  **/
  ...
  public TopologyProperties addDependsOnItem(String dependsOnItem) {
  ...
  **/
   ...
   * @return the TopologyProperties instance itself
   */
  public TopologyProperties putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TopologyProperties topologyProperties = (TopologyProperties) o;
    return Objects.equals(this.elementId, topologyProperties.elementId) &&
        Objects.equals(this.dependsOn, topologyProperties.dependsOn)&&
        Objects.equals(this.additionalProperties, topologyProperties.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(elementId, dependsOn, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TopologyProperties {\n");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TopologyProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TopologyProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TopologyProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TopologyProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<TopologyProperties>() {
           @Override
           public void write(JsonWriter out, TopologyProperties value) throws IOException {
