...
public class ServiceProfileAndFilter {
  ...
  private List<ServiceProfileSimpleExpression> and = null;
  ...
  **/
   ...
   * @return the ServiceProfileAndFilter instance itself
   */
  public ServiceProfileAndFilter putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.and, serviceProfileAndFilter.and)&&
        Objects.equals(this.additionalProperties, serviceProfileAndFilter.additionalProperties);
  }
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServiceProfileAndFilter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServiceProfileAndFilter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServiceProfileAndFilter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServiceProfileAndFilter.class));

       return (TypeAdapter<T>) new TypeAdapter<ServiceProfileAndFilter>() {
           @Override
           public void write(JsonWriter out, ServiceProfileAndFilter value) throws IOException {
