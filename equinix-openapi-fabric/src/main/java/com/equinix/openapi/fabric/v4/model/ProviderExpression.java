...
import com.equinix.openapi.fabric.v4.model.ProviderSearchExpressions;
...
public class ProviderExpression {
  ...
  public ProviderExpression addAndItem(ProviderSearchExpressions andItem) {
    if (this.and == null) {
  ...
  **/
  ...
  public ProviderExpression addOrItem(ProviderSearchExpressions orItem) {
    if (this.or == null) {
  ...
  **/
   ...
   * @return the ProviderExpression instance itself
   */
  public ProviderExpression putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ProviderExpression providerExpression = (ProviderExpression) o;
    return Objects.equals(this.and, providerExpression.and) &&
        Objects.equals(this.or, providerExpression.or)&&
        Objects.equals(this.additionalProperties, providerExpression.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProviderExpression {\n");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProviderExpression.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProviderExpression' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProviderExpression> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProviderExpression.class));

       return (TypeAdapter<T>) new TypeAdapter<ProviderExpression>() {
           @Override
           public void write(JsonWriter out, ProviderExpression value) throws IOException {
