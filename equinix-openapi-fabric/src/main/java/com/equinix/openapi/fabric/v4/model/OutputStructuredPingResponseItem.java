...
public class OutputStructuredPingResponseItem {
  ...
  **/
   ...
   * @return the OutputStructuredPingResponseItem instance itself
   */
  public OutputStructuredPingResponseItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OutputStructuredPingResponseItem outputStructuredPingResponseItem = (OutputStructuredPingResponseItem) o;
    return Objects.equals(this.bytes, outputStructuredPingResponseItem.bytes) &&
        Objects.equals(this.ip, outputStructuredPingResponseItem.ip) &&
        Objects.equals(this.icmpSeq, outputStructuredPingResponseItem.icmpSeq) &&
        Objects.equals(this.ttl, outputStructuredPingResponseItem.ttl) &&
        Objects.equals(this.time, outputStructuredPingResponseItem.time)&&
        Objects.equals(this.additionalProperties, outputStructuredPingResponseItem.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bytes, ip, icmpSeq, ttl, time, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OutputStructuredPingResponseItem {\n");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OutputStructuredPingResponseItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OutputStructuredPingResponseItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OutputStructuredPingResponseItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OutputStructuredPingResponseItem.class));

       return (TypeAdapter<T>) new TypeAdapter<OutputStructuredPingResponseItem>() {
           @Override
           public void write(JsonWriter out, OutputStructuredPingResponseItem value) throws IOException {
