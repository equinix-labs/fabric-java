...
public class LinkProtocol {
  ...
  **/
   ...
   * @return the LinkProtocol instance itself
   */
  public LinkProtocol putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, linkProtocol.type)&&
        Objects.equals(this.additionalProperties, linkProtocol.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LinkProtocol.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinkProtocol is not found in the empty JSON string", LinkProtocol.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinkProtocol.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<LinkProtocol> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinkProtocol.class));
       ...
       return (TypeAdapter<T>) new TypeAdapter<LinkProtocol>() {
           ...
           public LinkProtocol read(JsonReader in) throws IOException {
             ...
             LinkProtocol instance = thisAdapter.fromJsonTree(jsonObj);
