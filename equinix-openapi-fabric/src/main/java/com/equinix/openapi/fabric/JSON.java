...
public class JSON {
    ...
    public static GsonBuilder createGson() {
        GsonFireBuilder fireBuilder = new GsonFireBuilder()
                ...
                .registerTypeSelector(com.equinix.openapi.fabric.v4.model.ServiceProfileAccessPointType.class, new TypeSelector<com.equinix.openapi.fabric.v4.model.ServiceProfileAccessPointType>() {
                    @Override
                    public Class<? extends com.equinix.openapi.fabric.v4.model.ServiceProfileAccessPointType> getClassForElement(JsonElement readElement) {
                        Map<String, Class> classByDiscriminatorValue = new HashMap<String, Class>();
                        classByDiscriminatorValue.put("COLO", com.equinix.openapi.fabric.v4.model.ServiceProfileAccessPointTypeCOLO.class);
                        classByDiscriminatorValue.put("VD", com.equinix.openapi.fabric.v4.model.ServiceProfileAccessPointTypeVD.class);
                        classByDiscriminatorValue.put("ServiceProfileAccessPointType", com.equinix.openapi.fabric.v4.model.ServiceProfileAccessPointType.class);
                        return getClassByDiscriminator(classByDiscriminatorValue,
                                getDiscriminatorValue(readElement, "type"));
                    }
          })
...

    {
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.equinix.openapi.fabric.v4.model.FabricGateway.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.equinix.openapi.fabric.v4.model.FabricGatewayChangeOperation.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.equinix.openapi.fabric.v4.model.FabricGatewayFilter.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.equinix.openapi.fabric.v4.model.FabricGatewayFilters.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.equinix.openapi.fabric.v4.model.FabricGatewayOrFilter.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.equinix.openapi.fabric.v4.model.FabricGatewayPackageType.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.equinix.openapi.fabric.v4.model.FabricGatewayPackages.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.equinix.openapi.fabric.v4.model.FabricGatewayPostRequest.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.equinix.openapi.fabric.v4.model.FabricGatewaySearchRequest.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.equinix.openapi.fabric.v4.model.FabricGatewaySimpleExpression.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.equinix.openapi.fabric.v4.model.FabricGatewaySortCriteria.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.equinix.openapi.fabric.v4.model.SimplifiedServiceToken.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.equinix.openapi.fabric.v4.model.ValidateConnectionRequest.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.equinix.openapi.fabric.v4.model.ValidateConnectionRequestFilter.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.equinix.openapi.fabric.v4.model.ValidateConnectionRequestFilterAnd.CustomTypeAdapterFactory());
