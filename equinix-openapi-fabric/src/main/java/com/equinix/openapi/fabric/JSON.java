...
public class JSON {
...

    {
        ...
        gsonBuilder.setExclusionStrategies(new PhysicalPortSpeedExclusionStrategy());
        gson = gsonBuilder.setPrettyPrinting().create();
    }

    public class PhysicalPortSpeedExclusionStrategy implements ExclusionStrategy {

        // business logic to exclude field
        @Override
        public boolean shouldSkipField(FieldAttributes fieldAttributes) {
            return "physicalPortsSpeed".equalsIgnoreCase(fieldAttributes.getName());
        }
    ...
    public static GsonBuilder createGson() {
        ...
        GsonBuilder builder = fireBuilder.createGsonBuilder().setPrettyPrinting();
        return builder;
    }
