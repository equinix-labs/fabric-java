...
import com.equinix.openapi.fabric.v4.model.ProviderType;
import com.equinix.openapi.fabric.v4.model.ProvidersSearchResponse;
...
public class ProviderSearchResponse {
  ...
  **/
  ...
  public ProviderSearchResponse addDataItem(ProvidersSearchResponse dataItem) {
    if (this.data == null) {
  ...
  **/
   ...
   * @return the ProviderSearchResponse instance itself
   */
  public ProviderSearchResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ProviderSearchResponse providerSearchResponse = (ProviderSearchResponse) o;
    return Objects.equals(this.type, providerSearchResponse.type) &&
        Objects.equals(this.data, providerSearchResponse.data)&&
        Objects.equals(this.additionalProperties, providerSearchResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProviderSearchResponse {\n");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProviderSearchResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProviderSearchResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProviderSearchResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProviderSearchResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ProviderSearchResponse>() {
           @Override
           public void write(JsonWriter out, ProviderSearchResponse value) throws IOException {
