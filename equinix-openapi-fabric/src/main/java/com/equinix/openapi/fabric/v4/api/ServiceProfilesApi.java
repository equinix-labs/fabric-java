...
public class ServiceProfilesApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Successful Put operation </td><td>  * ETag -  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Not Found </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call searchServiceProfilesCall(ServiceProfileSearchRequest serviceProfileSearchRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call searchServiceProfilesValidateBeforeCall(ServiceProfileSearchRequest serviceProfileSearchRequest, final ApiCallback _callback) throws ApiException {
        ...
        return searchServiceProfilesCall(serviceProfileSearchRequest, _callback);
     ...
     */
    public ServiceProfiles searchServiceProfiles(ServiceProfileSearchRequest serviceProfileSearchRequest) throws ApiException {
        ApiResponse<ServiceProfiles> localVarResp = searchServiceProfilesWithHttpInfo(serviceProfileSearchRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ServiceProfiles> searchServiceProfilesWithHttpInfo(ServiceProfileSearchRequest serviceProfileSearchRequest) throws ApiException {
        okhttp3.Call localVarCall = searchServiceProfilesValidateBeforeCall(serviceProfileSearchRequest, null);
        Type localVarReturnType = new TypeToken<ServiceProfiles>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call searchServiceProfilesAsync(ServiceProfileSearchRequest serviceProfileSearchRequest, final ApiCallback<ServiceProfiles> _callback) throws ApiException {

        okhttp3.Call localVarCall = searchServiceProfilesValidateBeforeCall(serviceProfileSearchRequest, _callback);
        Type localVarReturnType = new TypeToken<ServiceProfiles>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
