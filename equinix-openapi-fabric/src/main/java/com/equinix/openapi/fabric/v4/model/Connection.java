...
public class Connection {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bandwidth, connection.bandwidth) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bandwidth, aSide, change, isRemote, description, changeLog, project, type, uuid, zSide, name, additionalInfo, href, state, redundancy, operation, notifications, account, order, direction, additionalProperties);
  }
