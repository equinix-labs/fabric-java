...
public class StreamAsset {
  ...
  **/
   ...
   * @return the StreamAsset instance itself
   */
  public StreamAsset putAdditionalProperty(String key, Object value) {
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StreamAsset.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StreamAsset' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StreamAsset> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StreamAsset.class));

       return (TypeAdapter<T>) new TypeAdapter<StreamAsset>() {
           @Override
           public void write(JsonWriter out, StreamAsset value) throws IOException {
