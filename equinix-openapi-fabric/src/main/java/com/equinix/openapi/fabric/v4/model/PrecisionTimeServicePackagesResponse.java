...
public class PrecisionTimeServicePackagesResponse {
  ...
  **/
  ...
  public PrecisionTimeServicePackagesResponse data(List<PackageResponse> data) {
    
    this.data = data;
    return this;
  }

  public PrecisionTimeServicePackagesResponse addDataItem(PackageResponse dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public List<PackageResponse> getData() {
    return data;
  }


  public void setData(List<PackageResponse> data) {
    this.data = data;
  }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            PackageResponse.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
          };
        }
      }
  }
