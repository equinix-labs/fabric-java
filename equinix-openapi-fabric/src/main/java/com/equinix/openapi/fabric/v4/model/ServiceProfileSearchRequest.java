...
public class ServiceProfileSearchRequest {
  ...
  private List<ServiceProfileSortCriteria> sort = null;
  ...
  **/
   ...
   * @return the ServiceProfileSearchRequest instance itself
   */
  public ServiceProfileSearchRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.filter, serviceProfileSearchRequest.filter) &&
        ...
        Objects.equals(this.additionalProperties, serviceProfileSearchRequest.additionalProperties);
  }
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServiceProfileSearchRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServiceProfileSearchRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServiceProfileSearchRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServiceProfileSearchRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ServiceProfileSearchRequest>() {
           @Override
           public void write(JsonWriter out, ServiceProfileSearchRequest value) throws IOException {
