...
public class LinkProtocolConnection {
  ...
  **/
  ...
  public LinkProtocolConnection uuid(UUID uuid) {
  ...
  **/
   ...
   * @return the LinkProtocolConnection instance itself
   */
  public LinkProtocolConnection putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.href, linkProtocolConnection.href) &&
        ...
        Objects.equals(this.additionalProperties, linkProtocolConnection.additionalProperties);
  }
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinkProtocolConnection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinkProtocolConnection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinkProtocolConnection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinkProtocolConnection.class));

       return (TypeAdapter<T>) new TypeAdapter<LinkProtocolConnection>() {
           @Override
           public void write(JsonWriter out, LinkProtocolConnection value) throws IOException {
