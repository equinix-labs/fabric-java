...
public class RoutingProtocolChangeOperation {
  ...
  **/
   ...
   * @return the RoutingProtocolChangeOperation instance itself
   */
  public RoutingProtocolChangeOperation putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.op, routingProtocolChangeOperation.op) &&
        ...
        Objects.equals(this.additionalProperties, routingProtocolChangeOperation.additionalProperties);
  }
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RoutingProtocolChangeOperation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RoutingProtocolChangeOperation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RoutingProtocolChangeOperation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RoutingProtocolChangeOperation.class));

       return (TypeAdapter<T>) new TypeAdapter<RoutingProtocolChangeOperation>() {
           @Override
           public void write(JsonWriter out, RoutingProtocolChangeOperation value) throws IOException {
