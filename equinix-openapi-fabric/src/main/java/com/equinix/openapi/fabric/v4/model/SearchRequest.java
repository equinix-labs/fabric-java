...
import com.equinix.openapi.fabric.v4.model.Expression;
import com.equinix.openapi.fabric.v4.model.PaginationRequest;
import com.equinix.openapi.fabric.v4.model.SortCriteria;
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("filter") != null && !jsonObj.get("filter").isJsonNull()) {
        Expression.validateJsonObject(jsonObj.getAsJsonObject("filter"));
      }
      ...
      if (jsonObj.get("sort") != null && !jsonObj.get("sort").isJsonNull()) {
        ...
        if (jsonArraysort != null) {
          ...
          for (int i = 0; i < jsonArraysort.size(); i++) {
            SortCriteria.validateJsonObject(jsonArraysort.get(i).getAsJsonObject());
          };
        }
      }
  }
