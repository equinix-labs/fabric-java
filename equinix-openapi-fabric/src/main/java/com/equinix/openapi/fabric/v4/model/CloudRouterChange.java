...
public class CloudRouterChange {
  ...
  **/
   ...
   * @return the CloudRouterChange instance itself
   */
  public CloudRouterChange putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.uuid, cloudRouterChange.uuid) &&
        ...
        Objects.equals(this.additionalProperties, cloudRouterChange.additionalProperties);
  }
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CloudRouterChange.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CloudRouterChange' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CloudRouterChange> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CloudRouterChange.class));

       return (TypeAdapter<T>) new TypeAdapter<CloudRouterChange>() {
           @Override
           public void write(JsonWriter out, CloudRouterChange value) throws IOException {
