...
public class ServiceSearchResponse {
  ...
  private List<PrecisionTimeServiceResponse> data = new ArrayList<>();
  ...
  **/
  ...
  public ServiceSearchResponse data(List<PrecisionTimeServiceResponse> data) {
  ...
  **/
  ...
  public List<PrecisionTimeServiceResponse> getData() {
    return data;
  }


  public void setData(List<PrecisionTimeServiceResponse> data) {
    this.data = data;
  }
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<ServiceSearchResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServiceSearchResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ServiceSearchResponse>() {
           @Override
