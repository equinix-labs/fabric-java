...
public class TimeServiceOrFilter {
  ...
  private List<TimeServiceSimpleExpression> or = new ArrayList<>();

  public TimeServiceOrFilter() {
  }

  public TimeServiceOrFilter or(List<TimeServiceSimpleExpression> or) {
  ...
  **/
  ...
  public List<TimeServiceSimpleExpression> getOr() {
    return or;
  }


  public void setOr(List<TimeServiceSimpleExpression> or) {
    this.or = or;
  }
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<TimeServiceOrFilter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimeServiceOrFilter.class));

       return (TypeAdapter<T>) new TypeAdapter<TimeServiceOrFilter>() {
           @Override
