...
public class ConnectionsApi {
     ...
     */
    public Connection createConnectionAction(String connectionId, ConnectionActionRequest connectionActionRequest) throws ApiException {
        ApiResponse<Connection> localVarResp = createConnectionActionWithHttpInfo(connectionId, connectionActionRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Connection> createConnectionActionWithHttpInfo(String connectionId, ConnectionActionRequest connectionActionRequest) throws ApiException {
     ...
     */
    public okhttp3.Call createConnectionActionAsync(String connectionId, ConnectionActionRequest connectionActionRequest, final ApiCallback<Connection> _callback) throws ApiException {
    ...
    /**
     * Build call for createConnectionsInBulk
     * @param connectionBulkPostRequest  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call createConnectionsInBulkCall(ConnectionBulkPostRequest connectionBulkPostRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = connectionBulkPostRequest;

        // create path and map variables
        String localVarPath = "/fabric/v4/connections/bulk";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createConnectionsInBulkValidateBeforeCall(ConnectionBulkPostRequest connectionBulkPostRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'connectionBulkPostRequest' is set
        if (connectionBulkPostRequest == null) {
            throw new ApiException("Missing the required parameter 'connectionBulkPostRequest' when calling createConnectionsInBulk(Async)");
        }

        return createConnectionsInBulkCall(connectionBulkPostRequest, _callback);
     ...
     */
    public ConnectionBulk createConnectionsInBulk(ConnectionBulkPostRequest connectionBulkPostRequest) throws ApiException {
        ApiResponse<ConnectionBulk> localVarResp = createConnectionsInBulkWithHttpInfo(connectionBulkPostRequest);
        return localVarResp.getData();
    }
     ...
     * This API provides capability to create bulk virtual connections
     * @param connectionBulkPostRequest  (required)
     * @return ApiResponse&lt;ConnectionBulk&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ConnectionBulk> createConnectionsInBulkWithHttpInfo(ConnectionBulkPostRequest connectionBulkPostRequest) throws ApiException {
        okhttp3.Call localVarCall = createConnectionsInBulkValidateBeforeCall(connectionBulkPostRequest, null);
        Type localVarReturnType = new TypeToken<ConnectionBulk>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Bulk Connections (asynchronously)
     * This API provides capability to create bulk virtual connections
     * @param connectionBulkPostRequest  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call createConnectionsInBulkAsync(ConnectionBulkPostRequest connectionBulkPostRequest, final ApiCallback<ConnectionBulk> _callback) throws ApiException {

        okhttp3.Call localVarCall = createConnectionsInBulkValidateBeforeCall(connectionBulkPostRequest, _callback);
        Type localVarReturnType = new TypeToken<ConnectionBulk>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call deleteConnectionByUuidCall(UUID connectionId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteConnectionByUuidValidateBeforeCall(UUID connectionId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'connectionId' is set
        if (connectionId == null) {
     ...
     */
    public Connection deleteConnectionByUuid(UUID connectionId) throws ApiException {
     ...
     */
    public ApiResponse<Connection> deleteConnectionByUuidWithHttpInfo(UUID connectionId) throws ApiException {
     ...
     */
    public okhttp3.Call deleteConnectionByUuidAsync(UUID connectionId, final ApiCallback<Connection> _callback) throws ApiException {
     ...
     * @param validateByAuthKeyPostRequest  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call validateConnectionsCall(ValidateByAuthKeyPostRequest validateByAuthKeyPostRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = validateByAuthKeyPostRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call validateConnectionsValidateBeforeCall(ValidateByAuthKeyPostRequest validateByAuthKeyPostRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'validateByAuthKeyPostRequest' is set
        if (validateByAuthKeyPostRequest == null) {
            throw new ApiException("Missing the required parameter 'validateByAuthKeyPostRequest' when calling validateConnections(Async)");
        }

        return validateConnectionsCall(validateByAuthKeyPostRequest, _callback);
     ...
     */
    public ConnectionResponse validateConnections(ValidateByAuthKeyPostRequest validateByAuthKeyPostRequest) throws ApiException {
        ApiResponse<ConnectionResponse> localVarResp = validateConnectionsWithHttpInfo(validateByAuthKeyPostRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ConnectionResponse> validateConnectionsWithHttpInfo(ValidateByAuthKeyPostRequest validateByAuthKeyPostRequest) throws ApiException {
        okhttp3.Call localVarCall = validateConnectionsValidateBeforeCall(validateByAuthKeyPostRequest, null);
        Type localVarReturnType = new TypeToken<ConnectionResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Validate AuthKey (asynchronously)
     * This API provides capability to validate by auth key
     * @param validateByAuthKeyPostRequest  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call validateConnectionsAsync(ValidateByAuthKeyPostRequest validateByAuthKeyPostRequest, final ApiCallback<ConnectionResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = validateConnectionsValidateBeforeCall(validateByAuthKeyPostRequest, _callback);
        Type localVarReturnType = new TypeToken<ConnectionResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
