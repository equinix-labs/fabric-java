...
public class Subnet {
  ...
  public Subnet type(TypeEnum type) {
  ...
  **/
  ...
  public Subnet ipv4(String ipv4) {
  ...
  **/
   ...
   * @return the Subnet instance itself
   */
  public Subnet putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, subnet.type) &&
        Objects.equals(this.name, subnet.name) &&
        Objects.equals(this.id, subnet.id) &&
        Objects.equals(this.vpcId, subnet.vpcId) &&
        Objects.equals(this.ipv4, subnet.ipv4)&&
        Objects.equals(this.additionalProperties, subnet.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, name, id, vpcId, ipv4, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Subnet>() {
           ...
           public Subnet read(JsonReader in) throws IOException {
             ...
             Subnet instance = thisAdapter.fromJsonTree(jsonObj);
