...
public class RouteTableEntryConnection {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, routeTableEntryConnection.name) &&
        Objects.equals(this.uuid, routeTableEntryConnection.uuid)&&
        Objects.equals(this.additionalProperties, routeTableEntryConnection.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, uuid, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to RouteTableEntryConnection
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RouteTableEntryConnection.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
