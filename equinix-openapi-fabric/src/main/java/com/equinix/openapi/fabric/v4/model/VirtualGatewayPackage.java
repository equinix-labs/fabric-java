...
public class VirtualGatewayPackage {
  ...
  public VirtualGatewayPackage staticIPv6RoutesMax(Integer staticIPv6RoutesMax) {
  ...
  **/
  ...
  public VirtualGatewayPackage naclRulesMax(Integer naclRulesMax) {
  ...
  **/
  ...
  public VirtualGatewayPackage code(Code code) {
  ...
  **/
  ...
  public VirtualGatewayPackage natType(NatTypeEnum natType) {
  ...
  **/
  ...
  public VirtualGatewayPackage description(String description) {
  ...
  **/
  ...
  public VirtualGatewayPackage changeLog(PackageChangeLog changeLog) {
  ...
  **/
  ...
  public VirtualGatewayPackage type(TypeEnum type) {
  ...
  **/
  ...
  public VirtualGatewayPackage totalIPv4RoutesMax(Integer totalIPv4RoutesMax) {
  ...
  **/
  ...
  public VirtualGatewayPackage haSupported(Boolean haSupported) {
  ...
  **/
  ...
  public VirtualGatewayPackage staticIPv4RoutesMax(Integer staticIPv4RoutesMax) {
  ...
  **/
  ...
  public VirtualGatewayPackage naclsMax(Integer naclsMax) {
  ...
  **/
  ...
  public VirtualGatewayPackage totalIPv6RoutesMax(Integer totalIPv6RoutesMax) {
  ...
  **/
  ...
  public VirtualGatewayPackage routeFilterSupported(Boolean routeFilterSupported) {
  ...
  **/
   ...
   * @return the VirtualGatewayPackage instance itself
   */
  public VirtualGatewayPackage putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VirtualGatewayPackage virtualGatewayPackage = (VirtualGatewayPackage) o;
    return Objects.equals(this.staticIPv6RoutesMax, virtualGatewayPackage.staticIPv6RoutesMax) &&
        Objects.equals(this.naclRulesMax, virtualGatewayPackage.naclRulesMax) &&
        Objects.equals(this.code, virtualGatewayPackage.code) &&
        Objects.equals(this.natType, virtualGatewayPackage.natType) &&
        Objects.equals(this.description, virtualGatewayPackage.description) &&
        Objects.equals(this.changeLog, virtualGatewayPackage.changeLog) &&
        Objects.equals(this.type, virtualGatewayPackage.type) &&
        Objects.equals(this.totalIPv4RoutesMax, virtualGatewayPackage.totalIPv4RoutesMax) &&
        Objects.equals(this.haSupported, virtualGatewayPackage.haSupported) &&
        Objects.equals(this.staticIPv4RoutesMax, virtualGatewayPackage.staticIPv4RoutesMax) &&
        Objects.equals(this.naclsMax, virtualGatewayPackage.naclsMax) &&
        Objects.equals(this.totalIPv6RoutesMax, virtualGatewayPackage.totalIPv6RoutesMax) &&
        Objects.equals(this.href, virtualGatewayPackage.href) &&
        Objects.equals(this.routeFilterSupported, virtualGatewayPackage.routeFilterSupported)&&
        Objects.equals(this.additionalProperties, virtualGatewayPackage.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(staticIPv6RoutesMax, naclRulesMax, code, natType, description, changeLog, type, totalIPv4RoutesMax, haSupported, staticIPv4RoutesMax, naclsMax, totalIPv6RoutesMax, href, routeFilterSupported, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VirtualGatewayPackage {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VirtualGatewayPackage
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VirtualGatewayPackage.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VirtualGatewayPackage is not found in the empty JSON string", VirtualGatewayPackage.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VirtualGatewayPackage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VirtualGatewayPackage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VirtualGatewayPackage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VirtualGatewayPackage.class));

       return (TypeAdapter<T>) new TypeAdapter<VirtualGatewayPackage>() {
           @Override
           public void write(JsonWriter out, VirtualGatewayPackage value) throws IOException {
           ...
           @Override
           public VirtualGatewayPackage read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VirtualGatewayPackage instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VirtualGatewayPackage given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VirtualGatewayPackage
  * @throws IOException if the JSON string is invalid with respect to VirtualGatewayPackage
  */
  public static VirtualGatewayPackage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VirtualGatewayPackage.class);
  }

 /**
  * Convert an instance of VirtualGatewayPackage to an JSON string
  *
  * @return JSON string
  */
