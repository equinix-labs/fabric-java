...
import com.equinix.openapi.fabric.v4.model.SearchDeploymentField;
...
public class DeploymentSearchExpressions {
  ...
  **/
  ...
  public DeploymentSearchExpressions addValuesItem(String valuesItem) {
    if (this.values == null) {
  ...
  **/
   ...
   * @return the DeploymentSearchExpressions instance itself
   */
  public DeploymentSearchExpressions putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DeploymentSearchExpressions deploymentSearchExpressions = (DeploymentSearchExpressions) o;
    return Objects.equals(this.property, deploymentSearchExpressions.property) &&
        Objects.equals(this.operator, deploymentSearchExpressions.operator) &&
        Objects.equals(this.values, deploymentSearchExpressions.values)&&
        Objects.equals(this.additionalProperties, deploymentSearchExpressions.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeploymentSearchExpressions {\n");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeploymentSearchExpressions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeploymentSearchExpressions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeploymentSearchExpressions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeploymentSearchExpressions.class));

       return (TypeAdapter<T>) new TypeAdapter<DeploymentSearchExpressions>() {
           @Override
           public void write(JsonWriter out, DeploymentSearchExpressions value) throws IOException {
