...
public class PtpAdvanceConfiguration {
   ...
   */
  @JsonAdapter(LogAnnounceIntervalEnum.Adapter.class)
  public enum LogAnnounceIntervalEnum {
    NUMBER_MINUS_3(-3),
    ...
    LogAnnounceIntervalEnum(Integer value) {
      this.value = value;
    }
    ...
    public static LogAnnounceIntervalEnum fromValue(Integer value) {
      for (LogAnnounceIntervalEnum b : LogAnnounceIntervalEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<LogAnnounceIntervalEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final LogAnnounceIntervalEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public LogAnnounceIntervalEnum read(final JsonReader jsonReader) throws IOException {
   ...
   */
  @JsonAdapter(LogSyncIntervalEnum.Adapter.class)
  public enum LogSyncIntervalEnum {
    NUMBER_MINUS_5(-5),
    ...
    LogSyncIntervalEnum(Integer value) {
      this.value = value;
    }
    ...
    public static LogSyncIntervalEnum fromValue(Integer value) {
      for (LogSyncIntervalEnum b : LogSyncIntervalEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<LogSyncIntervalEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final LogSyncIntervalEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public LogSyncIntervalEnum read(final JsonReader jsonReader) throws IOException {
        Integer value =  jsonReader.nextInt();
   ...
   */
  @JsonAdapter(LogDelayReqIntervalEnum.Adapter.class)
  public enum LogDelayReqIntervalEnum {
    NUMBER_MINUS_5(-5),
    ...
    LogDelayReqIntervalEnum(Integer value) {
      this.value = value;
    }
    ...
    public static LogDelayReqIntervalEnum fromValue(Integer value) {
      for (LogDelayReqIntervalEnum b : LogDelayReqIntervalEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<LogDelayReqIntervalEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final LogDelayReqIntervalEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public LogDelayReqIntervalEnum read(final JsonReader jsonReader) throws IOException {
        Integer value =  jsonReader.nextInt();
