...
public class EndCustomer {
  ...
  **/
   ...
   * @return the EndCustomer instance itself
   */
  public EndCustomer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.isDisclosed, endCustomer.isDisclosed) &&
        ...
        Objects.equals(this.additionalProperties, endCustomer.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(isDisclosed, name, mdmId, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("isDisclosed");
    openapiFields.add("name");
    openapiFields.add("mdmId");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if ((jsonObj.get("mdmId") != null && !jsonObj.get("mdmId").isJsonNull()) && !jsonObj.get("mdmId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `mdmId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mdmId").toString()));
      }
  }
