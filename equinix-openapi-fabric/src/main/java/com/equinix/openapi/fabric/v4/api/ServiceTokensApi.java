...
public class ServiceTokensApi {
    ...
    /**
     * Build call for updateServiceToken
     * @param serviceTokenId Service Token UUID (required)
     ...
     */
    public okhttp3.Call updateServiceTokenCall(UUID serviceTokenId, List<JsonPatchOperation> jsonPatchOperation, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateServiceTokenValidateBeforeCall(UUID serviceTokenId, List<JsonPatchOperation> jsonPatchOperation, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'serviceTokenId' is set
        if (serviceTokenId == null) {
            throw new ApiException("Missing the required parameter 'serviceTokenId' when calling updateServiceToken(Async)");
        }

        // verify the required parameter 'jsonPatchOperation' is set
        if (jsonPatchOperation == null) {
            throw new ApiException("Missing the required parameter 'jsonPatchOperation' when calling updateServiceToken(Async)");
        }

        return updateServiceTokenCall(serviceTokenId, jsonPatchOperation, _callback);
     ...
     */
    public ServiceToken updateServiceToken(UUID serviceTokenId, List<JsonPatchOperation> jsonPatchOperation) throws ApiException {
        ApiResponse<ServiceToken> localVarResp = updateServiceTokenWithHttpInfo(serviceTokenId, jsonPatchOperation);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ServiceToken> updateServiceTokenWithHttpInfo(UUID serviceTokenId, List<JsonPatchOperation> jsonPatchOperation) throws ApiException {
        okhttp3.Call localVarCall = updateServiceTokenValidateBeforeCall(serviceTokenId, jsonPatchOperation, null);
        Type localVarReturnType = new TypeToken<ServiceToken>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call updateServiceTokenAsync(UUID serviceTokenId, List<JsonPatchOperation> jsonPatchOperation, final ApiCallback<ServiceToken> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateServiceTokenValidateBeforeCall(serviceTokenId, jsonPatchOperation, _callback);
        Type localVarReturnType = new TypeToken<ServiceToken>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
