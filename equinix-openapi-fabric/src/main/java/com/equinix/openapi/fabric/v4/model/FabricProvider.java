...
import com.equinix.openapi.fabric.v4.model.FabricProviderResource;
...
public class FabricProvider {
  ...
  **/
   ...
   * @return the FabricProvider instance itself
   */
  public FabricProvider putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FabricProvider fabricProvider = (FabricProvider) o;
    return Objects.equals(this.type, fabricProvider.type) &&
        Objects.equals(this.resources, fabricProvider.resources)&&
        Objects.equals(this.additionalProperties, fabricProvider.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FabricProvider {\n");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FabricProvider.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FabricProvider' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FabricProvider> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FabricProvider.class));

       return (TypeAdapter<T>) new TypeAdapter<FabricProvider>() {
           @Override
           public void write(JsonWriter out, FabricProvider value) throws IOException {
