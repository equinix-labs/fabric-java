...
public class RoutingProtocolBase extends AbstractOpenApiSchema {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<RoutingProtocolBase>() {
                ...
                public void write(JsonWriter out, RoutingProtocolBase value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match anyOf schemas: RoutingProtocolBGPType, RoutingProtocolDirectType");
                }
                ...
                public RoutingProtocolBase read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        ret.setActualInstance(adapterRoutingProtocolBGPType.fromJsonTree(jsonObject));
                        return ret;
                    } catch (Exception e) {
                    ...
                    try {
                        ...
                        RoutingProtocolBase ret = new RoutingProtocolBase();
                        ret.setActualInstance(adapterRoutingProtocolDirectType.fromJsonTree(jsonObject));
                        return ret;
                    } catch (Exception e) {
                        // deserialization failed, continue
                    ...
                    throw new IOException(String.format("Failed deserialization for RoutingProtocolBase: no class matched. JSON: %s", jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount == 0) {
      throw new IOException(String.format("The JSON string is invalid for RoutingProtocolBase with anyOf schemas: RoutingProtocolBGPType, RoutingProtocolDirectType. JSON: %s", jsonObj.toString()));
    }
  }
