...
import com.equinix.openapi.fabric.v4.model.ActionRequest;
import com.equinix.openapi.fabric.v4.model.DeploymentActionType;
...
public class DeploymentActionRequest {
  ...
  **/
   ...
   * @return the DeploymentActionRequest instance itself
   */
  public DeploymentActionRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, deploymentActionRequest.type) &&
        Objects.equals(this.data, deploymentActionRequest.data)&&
        Objects.equals(this.additionalProperties, deploymentActionRequest.additionalProperties);
  }
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeploymentActionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeploymentActionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeploymentActionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeploymentActionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeploymentActionRequest>() {
           @Override
           public void write(JsonWriter out, DeploymentActionRequest value) throws IOException {
