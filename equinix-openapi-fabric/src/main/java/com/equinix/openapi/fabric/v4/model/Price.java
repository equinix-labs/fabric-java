...
public class Price {
  ...
  private List<PriceCharge> charges = null;
  ...
  private FabricGatewayPrice gateway;
  ...
  **/
  ...
  public Price gateway(FabricGatewayPrice gateway) {
  ...
  **/
  ...
  public FabricGatewayPrice getGateway() {
    return gateway;
  }


  public void setGateway(FabricGatewayPrice gateway) {
    this.gateway = gateway;
  }
  ...
  public boolean equals(Object o) {
    ...
    Price price = (Price) o;
    return Objects.equals(this.code, price.code) &&
        ...
        Objects.equals(this.gateway, price.gateway)&&
        Objects.equals(this.additionalProperties, price.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, catgory, ipBlock, description, type, charges, termLength, port, name, currency, connection, href, account, gateway, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("gateway") != null && !jsonObj.get("gateway").isJsonNull()) {
        FabricGatewayPrice.validateJsonObject(jsonObj.getAsJsonObject("gateway"));
      }
  }
