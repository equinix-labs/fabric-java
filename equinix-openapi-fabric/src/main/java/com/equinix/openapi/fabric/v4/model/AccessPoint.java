...
public class AccessPoint {
  ...
  **/
  ...
  public AccessPoint gateway(FabricGateway gateway) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, account, location, port, profile, gateway, linkProtocol, virtualDevice, _interface, network, sellerRegion, peeringType, authenticationKey, providerConnectionId, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("gateway") != null && !jsonObj.get("gateway").isJsonNull()) {
        FabricGateway.validateJsonObject(jsonObj.getAsJsonObject("gateway"));
      }
