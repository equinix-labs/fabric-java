...
public class MetroResponse {
  ...
  public MetroResponse addDataItem(Metro dataItem) {
    if (this.data == null) {
  ...
  **/
   ...
   * @return the MetroResponse instance itself
   */
  public MetroResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, metroResponse.data) &&
        Objects.equals(this.pagination, metroResponse.pagination)&&
        Objects.equals(this.additionalProperties, metroResponse.additionalProperties);
  }
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MetroResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MetroResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MetroResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MetroResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<MetroResponse>() {
           @Override
           public void write(JsonWriter out, MetroResponse value) throws IOException {
