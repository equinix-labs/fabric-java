...
public class NetworkAllOf {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(change, changeLog, links, href, state, uuid, connectionsCount, operation, account, additionalProperties);
  }
