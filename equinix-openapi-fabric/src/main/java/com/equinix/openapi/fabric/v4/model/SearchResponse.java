...
public class SearchResponse {
  ...
  private List<FabricGateway> data = new ArrayList<>();

  public SearchResponse() {
  }

  public SearchResponse pagination(Pagination pagination) {
  ...
  **/
  ...
  public SearchResponse data(List<FabricGateway> data) {
    
    this.data = data;
    return this;
  }

  public SearchResponse addDataItem(FabricGateway dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public List<FabricGateway> getData() {
    return data;
  }


  public void setData(List<FabricGateway> data) {
    this.data = data;
  }
   ...
   * @return the SearchResponse instance itself
   */
  public SearchResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pagination, searchResponse.pagination) &&
        Objects.equals(this.data, searchResponse.data)&&
        Objects.equals(this.additionalProperties, searchResponse.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SearchResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            FabricGateway.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
          };
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SearchResponse>() {
           ...
           public SearchResponse read(JsonReader in) throws IOException {
             ...
             SearchResponse instance = thisAdapter.fromJsonTree(jsonObj);
