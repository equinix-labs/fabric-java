...
public class SearchResponse {
  ...
  private List<VirtualGateway> data = null;
  ...
  public SearchResponse data(List<VirtualGateway> data) {
    
    this.data = data;
    return this;
  }

  public SearchResponse addDataItem(VirtualGateway dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public List<VirtualGateway> getData() {
    return data;
  }


  public void setData(List<VirtualGateway> data) {
    this.data = data;
  }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            VirtualGateway.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
          };
        }
      }
