...
public class SearchResponse {
  ...
  **/
  ...
  public SearchResponse data(List<CloudRouter> data) {
  ...
  **/
  ...
  public void setData(List<CloudRouter> data) {
    this.data = data;
  }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            CloudRouter.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
          };
        }
      }
  }
